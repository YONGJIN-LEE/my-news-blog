...
CATEGORIES = {
    ...
    "entertainment": "연예",
    "life": "생활",
    "health": "건강",     # 2026-05-10 추가
    "auto": "자동차",     # 2026-05-10 추가
    "it": "IT",
    "sports": "스포츠",
    "fashion": "패션",
}
...
CATEGORY_TO_SLUG = {
    ...
    "연예": "entertainment",
    "생활": "life",
    "건강": "health",     # 2026-05-10 추가
    "자동차": "auto",     # 2026-05-10 추가
    "IT": "it",
    "스포츠": "sports",
    "패션": "fashion",
    "Sports": "sports",
...
CATEGORY_COLORS = {
    ...
    "연예": ("#6c5ce7", "#a29bfe", "연예"),
    "생활": ("#00b894", "#55efc4", "생활"),
    "건강": ("#27ae60", "#82e0aa", "건강"),     # 2026-05-10 추가
    "자동차": ("#34495e", "#5d6d7e", "자동차"),  # 2026-05-10 추가
    "IT": ("#0984e3", "#74b9ff", "IT"),
